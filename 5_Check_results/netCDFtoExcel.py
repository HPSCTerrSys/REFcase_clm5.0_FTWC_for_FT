...
casename= 'Test_FT_HPSCTS_2_soil_var.clm2.h0'
excelname= 'Test_FT_HPSCTS_2_soil_var_soilLay=2_5cm'
Out_to_Excel(path,casename,param_list,'2010-01-01',path,excelname)

# Sim 2 to compare
path = r'/p/scratch/cslts/gonzalez5/10_clm5_0/CLM5_DATA/Archive/lnd/hist'
casename= 'Test_FTWC_ft_inputparm_v2.clm2.h0'
excelname= 'Test_FTWC_ft_inputparm_v2_soil_var_soilLay=2_5cm'
Out_to_Excel(path,casename,param_list,'2010-01-01',path,excelname)
...
# Sim 1 to compare
casename= 'Test_FT_HPSCTS_2_soil_var.clm2.h0'
excelname_d9= 'Test_FT_HPSCTS_2_soil_var_soilLay=9_100cm'
Out_to_Excel(path,casename,param_list,'2010-01-01',path,excelname_d9)

# Sim 2 to compare
casename= 'Test_FTWC_ft_inputparm_v2.clm2.h0'
excelname_d9= 'Test_FTWC_ft_inputparm_v2_soil_var_soilLay=9_100cm'
Out_to_Excel(path,casename,param_list,'2010-01-01',path,excelname_d9)