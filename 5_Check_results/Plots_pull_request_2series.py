...
#files =sorted(files)
#print(files,'\n')
bdt_full = pd.read_excel('Test_FTWC_ft_inputparm_v2_soil_var_soilLay=2_5cm.xlsx', index_col=0, header = [0])
bdt_full_sLay9 = pd.read_excel('Test_FTWC_ft_inputparm_v2_soil_var_soilLay=9_100cm.xlsx', index_col=0, header = [0])
...
os.chdir(r'/p/scratch/cslts/gonzalez5/10_clm5_0/CLM5_DATA/Archive/lnd/hist/')
#os.chdir(r'C:\0_Ana_Julich\2_PROJECTS\6_clm5_to_eclm_git\Olga_scripts_to_plot_ncresults\01_Check_WC_Peren=0')
apple_full = pd.read_excel('Test_FT_HPSCTS_2_soil_var_soilLay=2_5cm.xlsx', index_col=0, header = [0])
apple_full_sLay9 = pd.read_excel('Test_FT_HPSCTS_2_soil_var_soilLay=9_100cm.xlsx', index_col=0, header = [0])

#Path to save plots
os.chdir(r'/p/scratch/cslts/gonzalez5/10_clm5_0/Reference_data/00_Check_FTWC_ft_soil_var')
#os.chdir(r'C:\0_Ana_Julich\2_PROJECTS\6_clm5_to_eclm_git\Olga_scripts_to_plot_ncresults\01_Check_WC_Peren=0')
